        ...
        <>
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-sm-2 text-center "  style={{height: "80vh", backgroundColor: "black", overflowX: "hidden", overflowY: "auto"}}>Users<ActiveUsersList/></div>
                </div>
                <div className="row">
                    <div className="col-sm-10 text-center " style={{height:   "20vh", backgroundColor: "orange"}}>Rooms</div>
